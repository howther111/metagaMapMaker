...
if __name__ == '__main__':
    print("Program Start")
    # マップサイズ読込
    with open(settings2.mapFile, encoding="utf_8") as f:
        reader = csv.reader(f)
    ...
    backgrouwnIm = Image.open(settings2.backgroundImg)
    ...
    for y in range(yMax):
        ...
        alphaNum = numToAlpha.numToAlphaOne(num + 6)
    ...
    for y in range(yMax):
        for x in range(xMax):
            ...
            #mapChip = Image.new("RGBA", (w, h), (0, 0, 0, 255))
